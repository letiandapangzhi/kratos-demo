...
func newCompany(db *gorm.DB, opts ...gen.DOOption) company {
	...
	_company.Password = field.NewString(tableName, "password")
	_company.AppID = field.NewString(tableName, "app_id")
	_company.AppSecret = field.NewString(tableName, "app_secret")
	_company.CreateTime = field.NewTime(tableName, "create_time")
	_company.UpdateTime = field.NewTime(tableName, "update_time")
