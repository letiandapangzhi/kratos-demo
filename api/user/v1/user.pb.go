...
const file_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x12user/v1/user.proto\x12\auser.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1cgoogle/api/annotations.proto\"B\n" +
	...
	"\vaccessToken\x18\x01 \x01(\tR\vaccessToken\"\x8e\x01\n" +
	"\x18VerifyAccessTokenRequest\x12\\\n" +
	"\x05token\x18\x01 \x01(\tBF\xbaHC\xba\x01@\n" +
	"\vtoken_valid\x12\x1atoken must be a valid UUID\x1a\x15uint(this.size()) > 1R\x05token\x12\x14\n" +
